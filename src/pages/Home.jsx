...
export default function Home({ user, onLogout, onNavigate }) {
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7] dark:bg-[#1e1e1e] flex flex-col relative overflow-x-hidden">
      ...
      {/* Main Container Layout: Pakai Grid 3 Kolom di Desktop */}
      <div className="flex-1 pt-16 md:pt-24 px-4 md:px-8 w-full grid grid-cols-1 md:grid-cols-[300px_1fr] lg:grid-cols-[300px_1fr_360px] gap-6 items-start">
        
        {/* SIDEBAR KIRI: Mentok Kiri, Sembunyi di HP */}
        <aside className="hidden md:block w-full sticky top-24 z-0">
          <Sidebar_Kiri 
        ...
        {/* MAIN FEED: Dijamin Tepat di Tengah Layout */}
        <main className="w-full max-w-xl lg:max-w-2xl justify-self-center flex flex-col items-center">
          {posts.length === 0 ? (
        ...
        {/* SIDEBAR KANAN (Most Polling): Mentok Kanan */}
        <aside className="hidden lg:block w-full sticky top-24 z-0">
          <Most_Polling />
        </aside>
