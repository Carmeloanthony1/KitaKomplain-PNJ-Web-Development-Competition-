  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] dark:bg-[#292828] text-gray-900 dark:text-[#f1ece1] py-8 px-4 sm:px-8">
      <div className="max-w-4xl mx-auto flex flex-col gap-6">
        ...
        <div className="bg-white dark:bg-[#1e1e1e] rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="px-8 pb-8 relative">
            ...
            <div className="flex flex-col gap-2">
              ...
              {/* NOTIFIKASI JIKA MODE ANONIM AKTIF */}
              {isAnonim && (
                <div className="mt-2 p-3 bg-amber-500/10 border border-amber-500/30 rounded-xl inline-block">
                  <span className="text-sm font-medium text-amber-600 dark:text-amber-400 flex items-center gap-2">
                    🕵️ Pengguna ini mengaktifkan mode anonim untuk post, comment, dan vote.
                  </span>
                </div>
              )}
            </div>

            {/* STAT BADGES & DESKRIPSI (Tampil bila TIDAK anonim) */}
            {!isAnonim && (
              <>
                {/* Rangkuman Jumlah Posts, Comments, Polls (Sama kayak Profile) */}
        ...
        {/* NAVIGATION TABS & CONTENT (Tampil bila TIDAK anonim) */}
        {!isAnonim && (
          <>
            {/* Tabs Header */}
