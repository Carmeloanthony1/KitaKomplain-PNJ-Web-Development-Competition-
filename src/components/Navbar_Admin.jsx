...
export default function NavbarAdmin({ activeTab, setActiveTab }) {
  ...
  return (
    // FIX 1: Ganti `min-h-screen` jadi `h-screen sticky top-0`
      ...
      <div>
        ...
        >
          <span className="text-2xl group-hover:-translate-x-1 transition-transform">
            <svg className = "w-6 h-6 dark:fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
