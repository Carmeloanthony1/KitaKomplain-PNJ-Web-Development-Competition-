          ...
          <div key={index} className="flex flex-row items-center gap-2 w-full">
            ...
            <span 
              className={`font-black text-xs px-2 py-1 rounded-lg text-center flex-shrink-0 min-w-[32px] ${
                index === 0 
                  ? "bg-amber-400 text-amber-950 shadow-xs" // Rank 1: Emas
                  : index === 1 
                  ? "bg-slate-300 text-slate-800"          // Rank 2: Perak
                  : index === 2 
                  ? "bg-amber-700 text-white"              // Rank 3: Perunggu
                  : "bg-gray-100 text-gray-500 font-bold"   // Rank 4+: Neutral
              }`}
            >
              #{index + 1}
            </span>
