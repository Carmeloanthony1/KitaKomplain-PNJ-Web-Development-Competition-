...
export default function Sidebar_kiri({ onNavigate, openNotifications, openPostModal, openHistory }) {
  ...
  return (
    <aside className="-mt-4 w-64 min-h-[calc(100vh-80px)] flex flex-col justify-between p-6 bg-[#f7f7f7] dark:bg-[#1e1e1e]">
      {/* Menu Atas */}
      <div className="flex flex-col gap-14">
        <button 
          onClick={handleNewPost}
          className="flex items-center text-4xl gap-4 font-bold text-[#a50034] dark:text-[#f1ece1] cursor-pointer hover:opacity-80 transition"
        >
        ...
        <button 
          onClick={openHistory}
          className="flex items-center text-4xl font-bold cursor-pointer gap-4 text-[#a50034] dark:text-[#f1ece1] hover:opacity-80 transition"
        >
          <svg className="w-12 h-12 fill-[#a50034] dark:fill-[#f1ece1] flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
