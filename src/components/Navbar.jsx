  ...
  return (
    <div className="w-full bg-white dark:bg-[#1e1e1e] border-b border-gray-200 dark:border-slate-800 shadow-xs transition-colors">
      ...
      <nav className="relative w-full px-3 sm:px-6 md:px-10 py-2.5 sm:py-3 flex items-center justify-between">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 w-full max-w-[170px] sm:max-w-xs md:max-w-md lg:max-w-lg z-0">
          <form 
            onSubmit={handleSearch}
            className="relative flex items-center bg-white border border-[#a50034] sm:border-2 dark:border-[#f1ece1] dark:bg-black rounded-full px-3 sm:px-5 py-1 sm:py-2 w-full shadow-xs"
          >
            <input 
              ref={inputRef}
              type="text" 
