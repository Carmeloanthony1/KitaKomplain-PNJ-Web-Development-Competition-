    ...
    <div>
      <nav className="flex items-center justify-between w-full">
        <div onClick={() => navigate('/home')}
          className="cursor-pointer transition hover:scale-102 active:scale-109">
        ...
        <div className="flex items-center gap-2 bg-white border-2 border-[#a50034] rounded-full px-4 py-1.5 w-full max-w-md shadow-sm">
          <input 
            ...
            className="w-full bg-transparent text-black placeholder-[#a50034]/60 text-center font-medium cursor-pointer focus:outline-none px-2"
          />
        ...
        <div onClick={() => navigate('/profile')}
          ...
          <span className="text-lg">kenji</span>
